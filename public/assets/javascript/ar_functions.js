...
!function(e) {
    ...
    e.fn.HondaGallery = function(t) {
        ...
        return this.each(function() {
            ...
            var a = e(".portfolioCarrousel_nav li").length
              , o = 27 * a;
            e(".portfolioCarrousel_nav li").eq(a - 1).css({
                "margin-left": 0
            }),
            e(".portfolioCarrousel_nav").css({
                width: o - 10
            }),
            i.hover(function() {
    ...
    e.fn.HondaSelect = function(t) {
        ...
        return this.each(function() {
            ...
            var i = e(this)
              , a = i.attr("data-title")
              , o = i.find("ul.select_options").outerHeight(!0)
              , s = i.find(".select_drop_set")
    ...
    e.fn.countTo = function(t) {
        ...
        return e(this).each(function() {
            function a() {
                l += i,
                s++,
                e(o).html(l.toFixed(t.decimals)),
                "function" == typeof t.onUpdate && t.onUpdate.call(o, l),
                s >= n && (clearInterval(r),
                l = t.to,
                "function" == typeof t.onComplete && t.onComplete.call(o, l))
            }
            var o = this
              , s = 0
              , l = t.from
