...
class Inspiration extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Video(Vimeo ID)', 'video')
            ->sortable()
            ->rules( 'max:255')
            
            ,
            Text::make('Video Title(If video present)', 'video_title')
            ->sortable()
            ->rules( 'max:255')
            
            ,
            Text::make('Video brief(If video present)', 'video_brief')
            ->sortable()
            ->rules( 'max:255')
            
            ,

            Text::make('Arabic Video Title(If video present)', 'ar_video_title')
            ->sortable()
            ->rules( 'max:255')
            ...
            ,
            Text::make('Arabic  Video brief (If video present)', 'ar_video_brief')
            ->sortable()
            ->rules( 'max:255')
            ->withMeta(
                [
            ...
            Medialibrary::make('Gallery', 'inspirations'  , 'inspirations' )
            ->help(
