...
<div class="wrapper container" id="about">
	<section class="title_box_set">
		...
		<div class="box_title" style="top: 0px;">Request test drive</div>
	</section>
	<div class="responsive_title_box">Request test drive</div>
				...
				@csrf
						...
						<div class="form_block">
							...
							<div class="form_input textarea">
								...
								<textarea name="notes" class="re" placeholder="Notes" ></textarea>
							</div>
						</div>
